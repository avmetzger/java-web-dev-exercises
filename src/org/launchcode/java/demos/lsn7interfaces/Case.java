...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Tapioca Pearls", 0.75, new ArrayList<>(Arrays.asList("")));
        Topping topping2 = new Topping("Cherries", 0.45, new ArrayList<>(Arrays.asList("cherries","red #40")));
        Topping topping3 = new Topping("Whipped Topping", 0.00, new ArrayList<>(Arrays.asList("dairy")));
